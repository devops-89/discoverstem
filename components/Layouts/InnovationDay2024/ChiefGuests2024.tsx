...
import { chiefGuestsData2024 } from "@/assets/Generic-data";
...
export default function ChiefGuests2024() {
  return (
    <Box
      sx={{
    ...
    >
      ...
      >
        ...
        >
          {chiefGuestsData2024.map((guest, index) => (
            <Box
              key={index}
              sx={{
                display: "grid",
            ...
            >
              ...
              <Box sx={{ width: "100%", minWidth: 0 }}>
                ...
                >
                  Chief Guest · Innovation Day 2024
                </Typography>
