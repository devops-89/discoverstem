...
import { patentCertificatesData2024 } from "@/assets/Generic-data";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {patentCertificatesData2024.title}
        </Typography>
        ...
        <Box sx={{ position: "relative", px: { md: 5 } }}>
          ...
          >
            {patentCertificatesData2024.items.map((item) => (
