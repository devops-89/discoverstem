...
import { specialMessagesData2023 } from "@/assets/Generic-data";
import { Box, Container, Typography, Dialog, IconButton } from "@mui/material";
import Image from "next/image";
import CloseIcon from "@mui/icons-material/Close";

export default function SpecialMessages2023() {
  ...
  return (
    ...
    >
      ...
      >
        {specialMessagesData2023.items.map((item, index) => (
          <Box
            key={index}
