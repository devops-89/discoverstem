  ...
  return (
    ...
    >
      ...
      <Box sx={{ p: { xs: 3, lg: "30px" } }}>
        ...
        <Typography sx={{ fontFamily: "Poppins", fontWeight: 400, fontSize: { xs: "12px", lg: "16px" }, lineHeight: "16px", letterSpacing: "2.4px", textTransform: "uppercase", color: "#F9A51E", mb: { xs: 1.5, lg: 2 } }}>
          {data.category}
        </Typography>
        <Typography sx={{ fontFamily: "Poppins", fontWeight: 600, fontSize: { xs: "22px", lg: "25.6px" }, lineHeight: { xs: "28px", lg: "29.4px" }, letterSpacing: "-0.64px", color: "#000000", mb: 1 }}>
          {data.name}
        </Typography>
        <Typography sx={{ fontFamily: "Poppins", fontWeight: 400, fontSize: { xs: "13px", lg: "14px" }, lineHeight: "20px", color: "rgba(0,0,0,0.75)", mb: { xs: 2.5, lg: 3 } }}>
